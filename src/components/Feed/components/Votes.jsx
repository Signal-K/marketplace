...
import { useMoralisDapp } from "providers/MoralisDappProvider/MoralisDappProvider"; // Get the posts from the smart contract -> brings the elements from the contract provider
